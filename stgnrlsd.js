<script>
       ...
       //jQuery("#helpdesk_ticket_product_id").remove();
         jQuery('label.checkbox:contains("�Si hizo un dep�sito bancario adjunte la foto del recibo de pago")').css('color','#000');     
         jQuery("#helpdesk_ticket_subject").hide();
        ...
        jQuery('#helpdesk_ticket_custom_field_cf_solicitud_1539537 option:contains("Seleccione...")').css('color', '#ff8c00');
                ...
                //jQuery('#helpdesk_ticket_subject').val("PAGO DE MATR�CULA UTESA SEDE CICLO 2-2024");
